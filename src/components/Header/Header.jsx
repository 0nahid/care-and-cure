    ...
    return (
        <>
            <header className="text-gray-600 body-font mb-0 md:mb-32">
                <div className="relative mx-auto flex flex-wrap  sm:z-50 flex-col sm:fixed sm:top-0 sm:shadow-md sm:w-[100vw] sm:bg-white sm:flex-nowrap sm:justify-between sm:flex-row items-center">
                    ...
                    <nav className="z-50 bg-white border-slate-200 fixed bottom-0 left-0 border-t py-3 w-full text-base sm:border-t-0 sm:w-2/4 sm:relative md:border-0">
                        <div className="flex flex-nowrap w-full items-center justify-between mx-auto sm:justify-end sm:mr-0 sm:ml-auto">
                            ...
                            <span className="mr-5 flex">
                                <Link to="/profile">
                                    <img
                                        src="https://images.unsplash.com/photo-1580913428023-02c695666d61?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80"
                                        className="w-6 h-6 rounded-full md:mr-2"
                                        alt=""
                                    />
                                </Link>
                                <Link to="/profile" className="hidden md:block">Nahid Hassan Bulbul</Link>
                            </span>
                            <Link
                                to="/login"
                            ...
                            <FiLogOut className="cursor-pointer w-6 h-6 text-[#f91944]" />
